...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/Users/toni/tfm_meaconing_ws/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/Users/toni/robostack/.pixi/envs/jazzy/bin/python3.12"
